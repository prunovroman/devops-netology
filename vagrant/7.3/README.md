...
---
=======
# Результаты домашнего задания "7.3. Основы и принцип работы Терраформ"
...
Ссылка на файлы terraform: <https://github.com/prunovr/devops-netology/tree/main/terraform>
...
Terraform will perform the following actions:
  ...
  # aws_instance.web1["vm1"] will be created
  ...
  # aws_instance.web1["vm2"] will be created
  + resource "aws_instance" "web1" {
      + ami                                  = "ami-0ac59804e0c10a625"
      + arn                                  = (known after apply)
      + associate_public_ip_address          = (known after apply)
...
```
>>>>>>> d2bd88358d5d7fbd2d532674f2f4a8266ab71737
